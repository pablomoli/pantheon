...
#   - .env with OPENROUTER_API_KEY (and optional OPENROUTER_* overrides)
#
# Usage:
...
[[ -n "${OPENROUTER_API_KEY:-}" ]] || die "OPENROUTER_API_KEY is required in .env"
OR_BASE="${OPENROUTER_API_BASE:-https://openrouter.ai/api/v1}"
OR_REF="${OPENROUTER_HTTP_REFERER:-}"
OR_TITLE="${OPENROUTER_TITLE:-Pantheon}"
PANTHEON_ENV="OPENROUTER_API_KEY=${OPENROUTER_API_KEY},OPENROUTER_API_BASE=${OR_BASE},OPENROUTER_HTTP_REFERER=${OR_REF},OPENROUTER_TITLE=${OR_TITLE},PANTHEON_ADK_ALLOW_ORIGINS=*"
IMPACT_ENV="OPENROUTER_API_KEY=${OPENROUTER_API_KEY},OPENROUTER_API_BASE=${OR_BASE},OPENROUTER_HTTP_REFERER=${OR_REF},OPENROUTER_TITLE=${OR_TITLE},PANTHEON_ADK_AGENTS_DIR=/app/adk_apps/impact_agent,PANTHEON_ADK_ALLOW_ORIGINS=*"
