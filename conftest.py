...
If the real packages are installed, we skip stubbing so that modules importing
them (e.g. voice/client.py) continue to work normally.
"""
...
def _is_installed(name: str) -> bool:
    """Return True if the package is genuinely installed (not already mocked)."""
...
if not _is_installed("google.adk"):
